...
switch($TourType)
{
	...
	case 6:
		...
		CreateDistance($TourId, $TourType, '_H', '18m-1', '18m-2');
		CreateDistance($TourId, $TourType, '_D', '18m-1', '18m-2');
		break;
	...
	case 7:
		...
		CreateDistance($TourId, $TourType, '_H', '25m-1', '25m-2');
		CreateDistance($TourId, $TourType, '_D', '25m-1', '25m-2');
		break;
...
switch($TourType)
{
	...
	case 6:
		...
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-[RBCL]{1,1}[K]{1,1}', '1', 1, 60, 1, 60);
	...
	case 7:
		// KS 2015-11-16
		CreateTargetFace($TourId, $i++, '3 spot', 'R%', '1', 2, 60, 2, 60);
		...
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'R%', '0', 1, 60, 1, 60);
	...
	case 22:
		...
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-[RBCL]{1,1}[K]{1,1}', '1', 1, 60);
