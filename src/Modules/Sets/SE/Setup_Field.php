...
switch($TourType) {
	case 10:
	case 12:
		CreateTargetFace($TourId, $i++, 'Röd påle', 'REG-^[CR]{1,1}[J]{0,1}[HD]{1,1}', '1',  6, 0, 6, 0);
		CreateTargetFace($TourId, $i++, 'Vit påle', 'REG-^[RCBL]{1,1}[K]{1,1}[HD]{1,1}', '1',  6, 0, 6, 0);
		CreateTargetFace($TourId, $i++, 'Blå påle', 'REG-^[B]{1,1}[J]{0,1}[HD]{1,1}', '1',  6, 0, 6, 0);
		CreateTargetFace($TourId, $i++, 'Blå påle', 'REG-^[CR]{1,1}[SMV]{1,1}[HD]{1,1}', '1',  6, 0, 6, 0);
		CreateTargetFace($TourId, $i++, 'Svart påle', 'REG-^[L]{1,1}[J]{0,1}[HD]{1,1}', '1',  6, 0, 6, 0);
		...
		CreateTargetFace($TourId, $i++, 'Svart/vit påle', 'REG-^[L]{1,1}[CSMV]{0,1}[HD]{1,1}', '1',  6, 0, 6, 0);
