...
switch($TourType) {
	case 11:
		CreateTargetFace($TourId, $i++, 'Röd påle', 'REG-^[C]{1,1}[J]{0,1}[HD]{1,1}', '1', 8, 0);
		CreateTargetFace($TourId, $i++, 'Blå påle', 'REG-^[RBLI]{1,1}[J]{0,1}[HD]{1,1}', '1', 8, 0);
		CreateTargetFace($TourId, $i++, 'Blå påle', 'REG-^[C]{1,1}[SMV]{1,1}[HD]{1,1}', '1', 8, 0);
