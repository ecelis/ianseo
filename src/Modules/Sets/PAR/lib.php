...
function CreateStandardClasses($TourId, $SubRule) {
	CreateClass($TourId, 1, 1,100, 0, 'M', 'M', '~M', 1, 'C,R,W1');
	CreateClass($TourId, 2, 1,100, 1, 'W', 'W', '~F', 1, 'C,R,W1');
...
function CreateStandardEvents($TourId, $SubRule, $Outdoor=true) {
	...
	CreateEvent($TourId, $i++, 0, 0,  8, $TargetC, 5, 3, 1, 5, 3, 1, 'MW1', 'Men W1 Open (Rec/Comp)', 0, 240, 240, 0, 0, '', '', $TargetSizeC, $DistanceC);
	CreateEvent($TourId, $i++, 0, 0,  8, $TargetC, 5, 3, 1, 5, 3, 1, 'WW1', 'Women W1 Open (Rec/Comp)', 0, 240, 240, 0, 0, '', '', $TargetSizeC, $DistanceC);
	...
	CreateEvent($TourId, $i++, 1, 0, 8, $TargetC, 4, 6, 3, 4, 6, 3, 'MW1', 'Men W1 Open (Rec/Comp) Team',0, 0, 0, 0, 0, '', '', $TargetSizeC, $DistanceC);
	CreateEvent($TourId, $i++, 1, 0, 8, $TargetC, 4, 6, 3, 4, 6, 3, 'WW1', 'Women W1 Open (Rec/Comp) Team',0, 0, 0, 0, 0, '', '', $TargetSizeC, $DistanceC);
	if($Outdoor)
		CreateEvent($TourId, $i++, 1, 0, 8, $TargetC, 4, 4, 2, 4, 4, 2, 'W1X', 'W1 Open (Rec/Comp) Mixed Team',0, 0, 0, 0, 0, '', '', $TargetSizeC, $DistanceC);
