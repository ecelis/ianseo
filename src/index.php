...
<th class="Title" width="10%"><?php print get_text('TourCode','Tournament');?></th>
<th class="Title" width="30%"><?php print get_text('TourName','Tournament');?></th>
<th class="Title" width="20%"><?php print get_text('TourCommitee','Tournament');?></th>
<th class="Title" width="18%"><?php print get_text('TourWhere','Tournament');?></th>
<th class="Title" width="17%"><?php print get_text('TourWhen','Tournament');?></th>
</tr>
<?php
	...
	{
?>
<tr><td colspan="6" class="Bold Center"><?php echo get_text('NoTourExists', 'Tournament') ?></td></tr>
<?php
	}
?>
</table>
