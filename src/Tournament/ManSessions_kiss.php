	...
	if (isset($_REQUEST['Command'])) {
		if ($_REQUEST['Command']=='SAVE') {
			if (!IsBlocked(BIT_BLOCK_TOURDATA)) {
				 ...
				 */
					$oldSession = array();
					$q = "SELECT SesOrder, SesName, SesFirstTarget, SesDtStart, SesDtEnd "
						. "FROM Session "
					...
					while($MyRow=safe_fetch($rs)) {
						$oldSession[$MyRow->SesOrder] = array("Name" => $MyRow->SesName, "First" => $MyRow->SesFirstTarget, "DtStart" => $MyRow->SesDtStart, "DtEnd" => $MyRow->SesDtEnd);
					}
