 ...
 */
	function insertSession($SesTournament,$SesOrder,$SesType,$SesName,$SesTar4Session,$SesAth4Target,$SesFirstTarget,$SesFollow,$SesDtStart=0,$SesDtEnd=0) {
		$ret=true;

		$q
			= "INSERT ignore INTO Session (SesTournament,SesOrder,SesType,SesName,SesTar4Session,SesAth4Target,SesFirstTarget,SesFollow,SesDtStart,SesDtEnd) "
			. "VALUES( "
 ...
 * @return mixed: true se ok; messaggio di errore altrimenti
 */
	function updateSession($SesTournament,$SesOrder,$SesType,$SesName,$SesTar4Session,$SesAth4Target,$SesFirstTarget,$SesFollow,$SesDtStart=0,$SesDtEnd=0,$forceRegenerateTargets=false)
	{
		$ret=true;
	...
	// vecchi parametri per la sessione Q (servono per l'eventuale rigenerazione dei bersagli)
		...
		$q
			...
			. "SET "
				...
				. "SesDtStart=".StrSafe_DB(($SesType=='F' ? $SesDtStart : 0)) . ","
				. "SesDtEnd=".StrSafe_DB(($SesType=='F' ? $SesDtEnd : 0)) . " "
			. "WHERE "
