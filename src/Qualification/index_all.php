...
<td class="Center" onClick="javascript:Went2Home(<?php print $MyRow->EnId; ?>);" id="TD_<?php print $MyRow->EnId; ?>">
<?php
	if ($MyRow->EnValid)
		print get_text('Went2Home', 'Tournament');
	else
		print get_text('BackFromHome', 'Tournament');
?>
</td>
