...
echo '<table class="Tabella">' ;
	...
	switch($CardType) {
		case 'A':
			...
			if($_SESSION['AccBooth']) {
				...
				while($u=safe_fetch($t)) {
					echo '<br/><input type="checkbox" name="TourId[]" id="TourId[]" onclick="updateView()" value="'.$u->ToId.'">'.$u->ToCode."\n";
				}
				echo '</div>';
			}
		case 'Q':
			...
			{
				echo '<br/><input type="checkbox" onclick="ShowEntries()" id="d_QSession_'.$s->SesOrder.'" name="Session[]" value="' . $s->SesOrder . '">Session ' . $s->Descr ."\n";
			}
		...
		case 'E':
			...
			{
				echo '<br/><input type="checkbox" onclick="ShowEntries()" id="d_ESession_'.$s->SesOrder.'" name="ESession[]" value="' . $s->SesOrder . '">Session ' . $s->Descr ."\n";
			}
			echo '<br/><input type="checkbox" name="SortByTarget" id="SortByTarget"'.($CardType=='A' ? '' : ' checked="checked"').' onclick="ShowEntries()">'.get_text('SortByTarget', 'Tournament')."\n";
			// solo i non stampati precedentemente?
			echo '<br/><input type="checkbox" name="PrintNotPrinted" id="PrintNotPrinted" checked="checked" onclick="ShowEntries()">'.get_text('BadgeOnlyNotPrinted', 'Tournament')."\n";
