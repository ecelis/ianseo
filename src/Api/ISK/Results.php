...
echo '<tr><th class="Title" colspan="7">' . get_text('ISK-Configuration') . '</th></tr>';
echo '<tr>';
...
echo '<tr>';
	...
	echo '<td><input type="button" value="'.htmlspecialchars(get_text('ISK-TruncateTable', 'Api')).'" onclick="window.location.href=\'?truncate=1\'"></td>';
echo '</tr>';
