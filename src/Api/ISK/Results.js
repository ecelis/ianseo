...
function LoadTablets(obj) {
	...
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		XMLHttp.open("GET", 'Res-LoadTablets.php?ses='+session+'&dist='+distance+'&end='+end+'&maxend='+document.getElementById('x_End').max,true);
...
function UpdateTablets() {
	...
	var XMLHttp=CreateXMLHttpRequestObject(); // private ajax value, overrides the global and eliminates the need for a queue management!
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		XMLHttp.open("GET", 'Res-UpdateTablets.php?ses='+session+'&dist='+distance+'&end='+end+'&maxend='+document.getElementById('x_End').max,true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
...
function SetAutoImport(action) {
	...
	var XMLHttp=CreateXMLHttpRequestObject(); // private ajax value, overrides the global and eliminates the need for a queue management!
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		XMLHttp.open("GET", 'Res-AutoImport.php?stop='+(action ? '0' : '1'),true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
...
function toggleSticky(obj) {
	...
	var XMLHttp=CreateXMLHttpRequestObject(); // private ajax value, overrides the global and eliminates the need for a queue management!
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		XMLHttp.open("GET", 'Res-ToggleSticky.php?ses='+session+'&dist='+distance+'&'+obj.id+'='+(obj.checked ? '1' : '0'),true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
...
function dataImport(Tgt) {
	...
	var XMLHttp=CreateXMLHttpRequestObject(); // private ajax value, overrides the global and eliminates the need for a queue management!
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		XMLHttp.open("GET", 'Res-DataImport.php?'+qry,true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
...
//	d.style.top=y+'px';
	...
	var XMLHttp=CreateXMLHttpRequestObject(); // private ajax value, overrides the global and eliminates the need for a queue management!
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		XMLHttp.open("GET", 'Res-SeeTarget.php?'+obj.getAttribute('value'),true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
					...
					if (XMLRoot.getAttribute('error')==0) {
						...
						var Arrows=document.getElementById('PopUpContent').querySelectorAll('span.Let-Z');
...
function popupRemove(obj) {
	...
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		...
		XMLHttp.open("GET", 'Res-RemoveEnd.php?'+qry.substring(1),true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
...
function popupImport(obj) {
	...
	if (XMLHttp.readyState==XHS_COMPLETE || XMLHttp.readyState==XHS_UNINIT) {
		...
		XMLHttp.open("GET", 'Res-ImportEnd.php?'+qry.substring(1),true);
		XMLHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		XMLHttp.onreadystatechange=function() {
			if (XMLHttp.readyState==XHS_COMPLETE && XMLHttp.status==200) {
				try {
