...
function rotQualc($TVsettings, $RULE) {
	...
	$ret[]='<div class="Title">'.$rankData['meta']['title'].$Title2Rows.rtrim($data['meta']['descr'], ' -)')
	.'</div>';
...
function rotQualcSettings($Settings) {
	global $CFG;
	$ret='<br/>';
...
function getPageDefaults(&$RMain) {
	...
	$ret=array(
			...
			'CountryCode' => 'flex: 1 0 3rem; font-size:0.5em; max-width:5rem; margin-left:-2rem',
