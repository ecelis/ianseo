...
function rotAbss($TVsettings, $RULE) {
	...
	$ret[]='<div class="Title">'.$rankData['meta']['title'].$Title2Rows.$data['meta']['descr'].$Title2Rows.$RecTitle
	...
	if($ViewTOT) $tmp.= '<div class="Gold Headers">' . ($archer['scoreSnap'] != $archer['score'] ?  $archer['score'] : "&nbsp;") . '</div>';
