...
<div class="medium">
<table class="Tabella">
<tr><th class="Title" colspan="4"><?php print get_text('Languages','Languages');?></th></tr>
...
<?php
	...
	foreach ($Lingue as $lang=>$langtext)
	{
		...
		print '	</td>'."\n";
		print '	<td>'."\n";
		print '		<a class="Link" href="index.php?UpdateLanguage=' . strtoupper($lang) . '">' . get_text('Aggiorna', 'Languages') . '</a>'."\n";
		print '	</td>'."\n";
		print '</tr>'."\n";
	}
