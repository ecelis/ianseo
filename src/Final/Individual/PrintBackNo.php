...
//Pettorali Personali
	...
	if(safe_num_rows($t)) echo '<img src="../../Tournament/ImgBackNumber.php?IdTpl=1"><br/><br/>';
	echo '<input type="button" value="' . get_text('BackNoEdit', 'BackNumbers') . '" onClick="document.location=\''.$CFG->ROOT_DIR.'Tournament/BackNumber.php?BackNo=1\'">'
	. '<br /><input type="button" value="' . get_text('BackNoExportLayout', 'BackNumbers') . '" onClick="document.location=\''.$CFG->ROOT_DIR.'Tournament/BackNumbersExport.php?BackNo=1\'">'
